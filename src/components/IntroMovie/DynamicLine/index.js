...
class DynamicLine {
  constructor(x1, y1, x2, y2) {
    ...
    this.container = new this.createjs.Container();
    //this.container.alpha = 0;
    this.container.regY = -0.5;

    this.startPoint = new this.createjs.Point(x1, y1);
    this.point1 = new this.createjs.Point(x1, y1);
    this.point2 = new this.createjs.Point(x1, y1);
    this.point3 = new this.createjs.Point(x1, y1);
    this.point4 = new this.createjs.Point(x2, y2);
    this.point5 = new this.createjs.Point(x2, y2);
    this.point6 = new this.createjs.Point(x2, y2);
    this.endPoint = new this.createjs.Point(x2, y2);
  ...
  drawPoints() {
    ...
    this.graphics = new this.createjs.Graphics();
    this.graphics.clear();
    this.graphics.setStrokeStyle(1);
    this.graphics.beginStroke('#05CF9D');

    this.line = new this.createjs.Shape(this.graphics);
  ...
  createLine(x1, y1, x2, y2) {
    var graphics = new this.createjs.Graphics();
    graphics.setStrokeStyle(1);
    graphics.beginStroke('black');
    graphics.lineTo(x1, y1);
    graphics.lineTo(x2, y2);

    var line = new this.createjs.Shape(graphics);
  ...
  createPoint(x, y, color) {
    ...
    var point = new this.createjs.Shape(graphics);
