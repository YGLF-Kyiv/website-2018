...
export default class SuccessfulPurchasePage extends React.Component {
  ...
  componentWillMount() {
    gaTrack({
      eventCategory: 'codeOfConduct',
      eventAction: 'codeOfConduct',
      eventLabel: 'CodeOfConduct',
    });
  }

  render() {
    return (
      <div className="page-code-of-conduct lines-bg">
        <div className="container container-fluid">

          <header>
            <h2>Conference Code of Conduct</h2>
            <p>
              All attendees, speakers, sponsors and
              volunteers at our conference are required to agree with the following code of conduct.
              Organisers will enforce this code throughout the event. We are expecting cooperation
          ...
          <section>
            ...
            <p>
              ...
              orientation, disability, physical appearance, body size, race, or religion (or lack
              thereof). We do not tolerate harassment of conference participants in any form. Sexual
              language and imagery is not appropriate for any conference venue, including talks,
              workshops, parties, Twitter and other online media. Conference participants violating
          ...
          <section>
            ...
            <p>
              If a participant engages in harassing behavior, the conference organisers may take
